...
public class OpenGlUtils {
	...
	public static int loadTexturefromBuffer(final Buffer data, final int width,final int height, final int usedTexId) {
		if(data == null)
			return NO_TEXTURE;
		int textures[] = new int[1];
		if (usedTexId == NO_TEXTURE) {
	...
	public static int loadTextureBitmap(final Bitmap bitmap){
		final int[] textureHandle = new int[1];
