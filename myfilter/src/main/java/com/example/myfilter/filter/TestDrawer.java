...
/*                    "  int r_val = int(color.r * 63.0);\n" +
    ...
    public TestDrawer(Context context, int texture)
    {
...
//        inputTextureHandles = OpenGlUtils.loadTexture(context, "filter/filtertable_rgb_second_sunny.jpg");
//
