...
public class JiaopianDrawer {
    ...
    public JiaopianDrawer(Context context, int texture)
    {
    ...
    public void draw(float[] mtx)
    {
        ...
        inputTextureHandles = OpenGlUtils.loadTexture(context, "filter/lut3d_table_film.jpg");
