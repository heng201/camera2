...
public class FendaiDrawer {
    ...
    public FendaiDrawer(Context context, int texture)
    {
    ...
    public void draw(float[] mtx)
    {
        ...
        inputTextureHandles = OpenGlUtils.loadTexture(context, "filter/lut3d_table_pink.jpg");
